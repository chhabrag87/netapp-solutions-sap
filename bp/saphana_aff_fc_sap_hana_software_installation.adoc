...
link:saphana_aff_fc_adding_additional_data_volume_partitions_for_sap_hana_single-host_systems.html[Next: Adding additional data volume partitions for SAP HANA single-host systems.]
