...
The minimum number of 12 NVMe SSDs for the first shelf supports up to 18 SAP HANA hosts. A fully populated shelf (24 SSDs) supports up to 48 SAP HANA hosts. The same applies to the internal disks of an AFF A800 system.
