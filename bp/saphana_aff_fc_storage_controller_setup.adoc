...
//
link:saphana_aff_fc_time_synchronization.html[Previous: Time synchronization.]
...
link:saphana_aff_fc_sap_hana_storage_connector_api.html[Next: SAP HANA storage connector API.]
