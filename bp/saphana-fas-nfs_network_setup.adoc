...
//
link:saphana-fas-nfs_infrastructure_setup_and_configuration_overview.html[Previous: Infrastructure setup and configuration.]
...
link:saphana-fas-nfs_time_synchronization.html[Next: Time synchronization.]
