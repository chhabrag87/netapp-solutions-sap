...
+
The following screenshots show the configuration of an SAP HANA system PR.
+
image:anf-cba-image15.png["This screenshot shows the configuration of an SAP HANA system PR."]
